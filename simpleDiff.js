...
// new - old: +ve means increase in probability (red), -ve means decrease in probability (green)
var diff = image2.subtract(image1).expression("change = (b(0) < -0.05 || b(0) > 0.05) ? b(0) : 0");
Map.addLayer(diff.updateMask(imgMask), {min: -1.0 + thres, max: 1.0 - thres, palette: ["green", "#FFFFE0", "red"], opacity:0.9}, "Change in irrigation within known croplands");
